...
export const fetchAllSchedules = async (favoriteTeams) => {
  ...
  const [nflGames, nhlGames, mlbGames, nbaGames, wnbaGames, plGames, laligaGames, mlsGames, f1Games, ncaafGames, worldCupGames, euroGames, intlGames, serieAGames, bundesligaGames, ncaaBaseballGames, womensIntlGames, uclGames, pwhlResult, nwslGames, championsLeagueGames] = await Promise.all([
