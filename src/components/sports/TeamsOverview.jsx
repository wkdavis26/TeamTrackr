            ...
            <div className="flex gap-3 text-xs mb-1">
              ...
              <div className="flex flex-col items-center bg-gray-50 rounded-lg px-2 py-1 flex-1">
                ...
                <span className="text-gray-400 truncate max-w-full text-center" title={standing._divName}>
                  {standing._divName
                    ? standing._divName.replace('Division', 'Div').replace('Northwest', 'NW').replace('Southwest', 'SW').replace('Southeast', 'SE').replace('Northeast', 'NE').replace('Atlantic', 'Atl').replace('Central', 'Cen').replace('Pacific', 'Pac')
                    : 'Div'}
                </span>
              </div>
              )
